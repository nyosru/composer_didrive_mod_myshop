...
// $vv['tpl_body'] = '';
$vv['tpl_body'] = \f\like_tpl(
        ( isset($vv['now_level']['no_cats'] ) ? 'sh-no.cat' : 'sh' )
        , dir_mods_mod_vers_tpl
        , dir_site_module_nowlev_tpl
        , DR );


//echo '<br/>1 '. dir_mods_mod_vers_tpl;
//echo '<br/>2 '. dir_site_module_nowlev_tpl;
...
//$vv['now_shop'] = Nyos\mod\myshop::getShopFromDomain($db);
        ...
        $sql->execute();
        Nyos\mod\myshop::$items = $vv['datain'] = $sql->fetchAll();
